...
-- Recreating retirement_info table with emp_no

-- Dropping the retirement_info table
...
-- Joining retirement_info and dept_emp tables into current_emp with current employees
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
    de.to_date
...
-- Creating new table with gender and salary info of current employees
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
...
-- List of retirees with their department info
SELECT ce.emp_no, 
	ce.first_name,
	ce.last_name,
	d.dept_name
...
-- List of retirees in the Sales and Development departments
SELECT ce.emp_no, 
	ce.first_name,
	ce.last_name,
	d.dept_name
